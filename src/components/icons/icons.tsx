...
// Define the type for common SVG props
...
export const InstagramIcon = ({
  ...
  >
    ...
    />
    <path
      fill={isMobileMenu && isLightTheme ? '#000' : '#fff'}
...
export const LeetCodeIcon = ({ className, ...rest }: SvgIconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    width="1.2em"
...
export const EmailIcon = ({ className, ...rest }: SvgIconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    ...
    className={`${className} w-full h-auto`}
  >
    <path fill="#4285f4" d="M24.3 111.3h17.2V69.6L16.9 51.3V104c0 4 3.3 7.3 7.4 7.3z" />
    <path fill="#34a853" d="M100.3 111.3h17.2c4.1 0 7.4-3.3 7.4-7.4V51.3l-24.5 18.4v41.6z" />
    <path fill="#fbbc04" d="M100.3 37.8v31.9l24.5-18.4v-9.8c0-9.1-10.4-14.3-17.7-8.8l-6.8 5.1z" />
    <path
      fill="#ea4335"
      fillRule="evenodd"
      d="M41.4 69.6V37.8l29.4 22.1 29.4-22.1v31.9l-29.3 22-29.5-22.1z"
      clipRule="evenodd"
    />
    <path fill="#c5221f" d="M16.9 41.4v9.8l24.5 18.4V37.8l-6.9-5.2c-7.2-5.4-17.6-.2-17.6 8.8z" />
  </svg>
);
